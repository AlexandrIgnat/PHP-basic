                        ...
                        <div class="panel-container show">
                            <div class="panel-content">
                                <div class="panel-content image-gallery">
                                    <div class="row">
                                    <?php if($_SESSION['images']) :?>
                                            <?php foreach($_SESSION['images'] as $image) :?>
                                                <div class="col-md-3 image">
                                                    <img src="img/upload/<?php echo $image['image']?>">
                                                    <a class="btn btn-danger" href="task_17_handler1_1.php?id=<?php echo $image['id']?>" onclick="confirm('Вы уверены?');">Удалить</a>
                                                </div>
                                            <?php endforeach?>
                                        <?php endif?>
                                        <!-- <div class="col-md-3 image">
